...
public class AICar : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else if ((braking == true) && (reset == false))
        {
            ...
            if (speed > 10f && delta_distance < 15f) // When speed larger than 10 km/h, pitch increases to 0.5 degrees
            {
            ...
            else if (speed < 10f && delta_distance < 15f) // When speed smaller than 10 km/h, pitch slowely decreases from 0.5 degrees
            {
            ...
            else if (Double.IsNaN(speed) || speed > 0f && speed < 5f && delta_distance > 15f) // Once distance is far enough and speed is almost zero, decrease pitch even more
            {
                Timer2 += Time.deltaTime;
                pitch = 0.5f - (Timer2);
            ...
            if (speed <= 0 && delta_distance > 15f)  // If car is standing still, change pitch back to zero.
            {
                Timer2 += Time.deltaTime;
                pitch = 0.5f - (Timer2);
